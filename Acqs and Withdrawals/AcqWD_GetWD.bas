...
Dim WDwb As Workbook
Set WDwb = Workbooks.Open(strFile)
...
Set Location = WDwb.Worksheets("Sheet1").Range("A:A")
Set SCAT = WDwb.Worksheets("Sheet1").Range("D:D")
...
If BoudAll <> BoudAdPrint + BoudJuvPrintTotal + BoudAdNon + BoudJuvNonTotal Then
    MsgBox ("Check Boudreau Juv/YA Withdrawals")
End If

COMPsh.Range("B25") = BoudAdPrint
COMPsh.Range("B26") = BoudJuvPrintTotal
COMPsh.Range("B30") = BoudAdNon
COMPsh.Range("B31") = BoudJuvNonTotal
...
If CSQAll <> CSQAdPrint + CSQJuvPrintTotal + CSQAdNon + CSQJuvNonTotal Then
    MsgBox ("Check CSQ Juv/YA Withdrawals")
End If

COMPsh.Range("D25") = CSQAdPrint
COMPsh.Range("D26") = CSQJuvPrintTotal
COMPsh.Range("D30") = CSQAdNon
COMPsh.Range("D31") = CSQJuvNonTotal
...
If CollinsAll <> CollinsAdPrint + CollinsJuvPrintTotal + CollinsAdNon + CollinsJuvNonTotal Then
    MsgBox ("Check Collins Juv/YA Withdrawals")
End If

COMPsh.Range("F25") = CollinsAdPrint
COMPsh.Range("F26") = CollinsJuvPrintTotal
COMPsh.Range("F30") = CollinsAdNon
COMPsh.Range("F31") = CollinsJuvNonTotal
...
If OConnAll <> OConnAdPrint + OConnJuvPrintTotal + OConnAdNon + OConnJuvNonTotal Then
    MsgBox ("Check OConnell Juv/YA Withdrawals")
End If

COMPsh.Range("J25") = OConnAdPrint
COMPsh.Range("J26") = OConnJuvPrintTotal
COMPsh.Range("J30") = OConnAdNon
COMPsh.Range("J31") = OConnJuvNonTotal
...
If ONeillAll <> ONeillAdPrint + ONeillJuvPrintTotal + ONeillAdNon + ONeillJuvNonTotal Then
    MsgBox ("Check ONeill Juv/YA Withdrawals")
End If

COMPsh.Range("L25") = ONeillAdPrint
COMPsh.Range("L26") = ONeillJuvPrintTotal
COMPsh.Range("L30") = ONeillAdNon
COMPsh.Range("L31") = ONeillJuvNonTotal
...
If ValAll <> ValAdPrint + ValJuvPrintTotal + ValAdNon + ValJuvNonTotal Then
    MsgBox ("Check Valente Juv/YA Withdrawals")
End If

COMPsh.Range("N25") = ValAdPrint
COMPsh.Range("N26") = ValJuvPrintTotal
COMPsh.Range("N30") = ValAdNon
COMPsh.Range("N31") = ValJuvNonTotal
...
If MainAll <> MainAdPrint + MainJuvPrintTotal + MainAdNon + MainJuvNonTotal Then
    MsgBox ("Check Main Juv/YA Withdrawals")
End If

COMPsh.Range("H25") = MainAdPrint + SRSPrint + CRPrint + RefPrint
COMPsh.Range("H26") = MainJuvPrintTotal
COMPsh.Range("H30") = MainAdNon
COMPsh.Range("H31") = MainJuvNonTotal
